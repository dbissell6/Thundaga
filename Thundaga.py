import argparse
from data_processing import create_dataframes_by_event_name, process_data, query_and_print_logs
...
def main():
    ...
    parser.add_argument('--evid', choices=['AWS','AWSQ','Wlogs'], help='AWS cloudlogs in JSON or Chainsaw sigma output of evtx logs')
